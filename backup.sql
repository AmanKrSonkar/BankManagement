CREATE DATABASE  IF NOT EXISTS `bankmanage` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `bankmanage`;
...
INSERT INTO `manager` VALUES (1010,'Aman',1010);
...
CREATE TABLE `staff` (
  ...
  `Date_of_LD` date DEFAULT NULL,
  `Date_of_LW` date DEFAULT NULL,
  `Last_Withdraw_Amm` int(20) DEFAULT NULL,
  `Phone_no` int(11) DEFAULT NULL,
  `Passward` int(5) DEFAULT NULL,
...
INSERT INTO `staff` VALUES (1010,'Aman',10000,'2016-09-01','2016-09-01',500,995600103,1010,'Accountant'),(1020,'Ak',2000,'2016-09-04','2016-09-04',200,908789654,1020,'Employ');
...
-- Dump completed on 2017-02-05 17:51:56
